...
class DocumentUploadChild extends StatefulWidget {
  ...
  const DocumentUploadChild(this.docUploadDetails,{Key? key}) : super(key: key);
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                    ...
                                    children: [
                                      SizedBox(
                                        ...
                                        child: Container(
                                          ...
                                          child: Center(
                                            child: Text("${widget.docUploadDetails.MAWBNo}",
                                      ...
                                      SizedBox(
                                        ...
                                        child: Container(
                                          ...
                                          color: Colors.yellow.shade100,
                                          child: Center(
                                            child: Text("${widget.docUploadDetails.Date}",
                                                // widget
                                                //     .selectedVtDetails
                                                //     .DRIVERNAME
                                                //     .toUpperCase(),
                                  ...
                                  SingleChildScrollView(
                                    ...
                                    child: Padding(
                                      ...
                                      child: DataTable(
                                          ...
                                          rows: docsDetailsList.map((cargo) => DataRow(
                                              ...
                                              cells: [
                                                DataCell(Text(cargo.docName)),
                                                DataCell(Center(
                                                  child: Text(
                                                              "${cargo.docStatus}"),
                                                )),
                                                DataCell(Text(cargo.docRemark)),
                                  ...
                                  //                   color:Colors.yellow.shade100,
                                  //                   child: Center(
                                  //                     child: Text('MAWB_99956565670.pdf',
                                  //                         style:
                                  //                         mobileYellowTextFontStyleBold),
                                  //                   ),
                                  //                 ),
...
class EdocDetails {
  ...
  static List<EdocDetails> getCargo() {
    return <EdocDetails>[
      EdocDetails("MAWB_99956565670",  20,"ajhjgsasda",),
      EdocDetails("MAWB_99956565671", 19, "ajdhasdjkhkj",),
      EdocDetails("MAWB_99956565672",  24,"ljgkkgmhg",),
      EdocDetails("MAWB_99956565673", 36, "skjfjfsjh",),
    ];
  }
}